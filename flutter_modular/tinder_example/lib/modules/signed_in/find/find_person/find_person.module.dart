...
class FindPersonModule extends Module {
  ...
  void routes(r) {
    ...
    r.child(AppCurrentPaths.findPersonDetails, child: (context) => const FindPersonDetailsView());
    r.child(AppCurrentPaths.findPersonMatch, child: (context) => const FindPersonMatchView());
  }
}
